...
CASES: Dict[int, CaseDef] = {
    ...
    2: CaseDef(
        ...
        chords=[
            ...
            Chord(t_up=3200, t_low=400,   f_min=0.0, f_max=0.95),
        ],
...
if __name__ == "__main__":
    ...
    fig_w.savefig("cases1-4_Wetherill_grid.svg")
    fig_w.savefig("cases1-4_Wetherill_grid.tiff")
    fig_w.savefig("cases1-4_Wetherill_grid.png")
    plt.show()

    # 3) write three separate files
    out_root = Path("output_alta_synth")
    out_root.mkdir(exist_ok=True)

    path_tw   = out_root / "cases1to4_synth_TW_test.csv"
    path_reim = out_root / "cases1to4_synth_reim_test.csv"
    path_weth = out_root / "cases1to4_synth_weth_test.csv"
